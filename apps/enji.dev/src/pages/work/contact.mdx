...
| Timezone | GMT+7                   |
| E-mail   | tioramadhan9f@gmail.com |
...
If you want to find me on social media, just search for **@tioramadhn**. That's my username on almost all platforms, so it should be easy to find me.

But if you're short on time, I've included some links to the social media platforms I use most frequently below.

| Social Media | Profile URL                        |
| ------------ | ---------------------------------- |
| LinkedIn     | https://linkedin.com/in/tioramadhn |
| Github       | https://github.com/tioramadhn      |
| Instagram    | https://instagram.com/tioramadhn   |
